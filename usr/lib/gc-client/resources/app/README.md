# Gamecredits desktop miner

Desktop application which simplified process of mining of gamecredits.
Application download and configure appropriate miner based on PC configuration.
Minimalist design and ease of use.

### Based on minimal Electron + React Starter Kit
